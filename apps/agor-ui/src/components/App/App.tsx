...
export const App: React.FC<AppProps> = ({
  ...
  // Comments panel size persistence (percentage of total width)
  ...
  // Ref for accessing SessionCanvas methods (e.g., getViewportCenter)
  const sessionCanvasRef = useRef<SessionCanvasRef>(null);

  // Default position for new worktree (from viewport center)
