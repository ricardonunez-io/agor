...
| ----------------------------- | -------------------------------- | --------------------------------------------------------- |
| **Parent Blocking**           | Parent locks while subagent runs | ✅ Parent remains responsive                              |
...
| **Multi-Tool Support**        | Claude Code only                 | ✅ Works with any agent (Claude, Codex, Gemini, OpenCode) |
...
<img
  src="/screenshots/subsession-codex-running.png"
...
<img
  src="/screenshots/parallel-spawn-5-codex.png"
...
<img
  src="/screenshots/parallel-first-callback.png"
